    ...
    return (
      <div className="container">
        <div className="row my-4 bg-light border rounded mx-0">
          <div className="col-12 col-md-4 picture picturepadding d-flex justify-content-center mt-2">
            <div className="middle">
              <h1> <ion-icon name="add-circle-outline" >+</ion-icon></h1>
            </div>
            <Dropzone width="100%" onDrop={this.props.onDrop} className="img-thumbnail" inputProps={{ className: 'maxWidth' }}><img className="img-thumbnail" width="100%" height="100%" src={this.props.mainState.image ? this.props.mainState.image : "../../../../../images/profileImage.png"} className="img-responsive" /></Dropzone>
          </div>
          <div className="col-12 col-md-4 flex-column justify-content-between align-self-stretch p-3 p-md-4">
            <h1>
